...
html_theme_options = {
    ...
    "switcher": {
        "json_url": "https://jthielen.github.io/geoips/versions.json", # TODO: update to NRLMMD-GEOIPS when used for real
        "version_match": "dev", # TODO: update this to be automatically determined rather than fixed
    }
}
